...
const Pagination: React.FC<PaginationProps> = ({ currentPage, totalPages, setCurrentPage }) => {
    ...
    return (
        <div className='w-full flex items-center justify-between pb-5 md:p-5'>
            <div className='bg-[#FFF] w-[136px] h-[40px] flex items-center justify-center'>
            ...
            <div>
                <div className='flex h-[34px] justify-center w-full gap-2 items-center'>
                    ...
                    <div 
                        ...
                        className={`bg-[#FFF] transition-all duration-500 ease-in-out flex justify-center items-center cursor-pointer w-8 h-full ${
